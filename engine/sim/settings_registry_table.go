...
func buildSettingRegistry() []SettingSpec {
	specs := []SettingSpec{
		...
		intSetting("road_damage_chance_permille", SettingEffectImmediate, func(s *WorldSettings) *int { return &s.RoadDamageChancePermille }),
		intSetting("road_damage_storm_chance_permille", SettingEffectImmediate, func(s *WorldSettings) *int { return &s.RoadDamageStormChancePermille }),
		...
		intSetting("shortage_peddler_days", SettingEffectImmediate, func(s *WorldSettings) *int { return &s.ShortagePeddlerDays }),
		intSetting("shortage_peddler_batches", SettingEffectImmediate, func(s *WorldSettings) *int { return &s.ShortagePeddlerBatches }),
		intSetting("carter_days", SettingEffectImmediate, func(s *WorldSettings) *int { return &s.CarterDays }),
