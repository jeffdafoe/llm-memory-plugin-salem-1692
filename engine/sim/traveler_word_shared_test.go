...
// traveler_word_shared_test.go — LLM-545: the traveler's carried word
...
// TestTravelerWordSharedThroughRealSpeak drives real SpeakTo calls: a traveler
...
// stamp.
func TestTravelerWordSharedThroughRealSpeak(t *testing.T) {
	...
	// The traveler speaks → recordTravelerWordShared fires.
...
// TestTravelerWordSharedReachesPublishedSnapshot covers the live actor →
...
// travelerWordSharedWith actually reads it — and the published copy must be
...
func TestTravelerWordSharedReachesPublishedSnapshot(t *testing.T) {
	w, stop := buildPayWithItemWorld(t, "h1", "sc1", []pwiActor{
		{id: "vstr-ashford", displayName: "Brother Ashford the provisioner", kind: sim.KindNPCShared, huddleID: "h1"},
		{id: "hannah", displayName: "Hannah Boggs", kind: sim.KindNPCShared, huddleID: "h1"},
	})
...
// TestTravelerWordSharedRejectedSpeakStampsNothing: the stamp lives AFTER the
...
func TestTravelerWordSharedRejectedSpeakStampsNothing(t *testing.T) {
	w, stop := buildPayWithItemWorld(t, "h1", "sc1", []pwiActor{
		{id: "vstr-ashford", displayName: "Brother Ashford the provisioner", kind: sim.KindNPCShared, huddleID: "h1"},
		{id: "hannah", displayName: "Hannah Boggs", kind: sim.KindNPCShared, huddleID: "h1"},
		{id: "mary", displayName: "Mary", kind: sim.KindNPCShared, huddleID: "h1"},
...
// TestTravelerWordSharedSkipsStaleHuddleMember: a huddle member id with NO live
...
func TestTravelerWordSharedSkipsStaleHuddleMember(t *testing.T) {
	w, stop := buildPayWithItemWorld(t, "h1", "sc1", []pwiActor{
		{id: "vstr-ashford", displayName: "Brother Ashford the provisioner", kind: sim.KindNPCShared, huddleID: "h1"},
		{id: "hannah", displayName: "Hannah Boggs", kind: sim.KindNPCShared, huddleID: "h1"},
	})
...
// TestTravelerWordSharedRequiresPayload: a traveler with no carried word stamps
// nothing — there is no matter to spend.
func TestTravelerWordSharedRequiresPayload(t *testing.T) {
	w, stop := buildPayWithItemWorld(t, "h1", "sc1", []pwiActor{
...
// TestTravelerWordSharedNonVisitorSpeakerNoop: a resident speaker never gains
...
func TestTravelerWordSharedNonVisitorSpeakerNoop(t *testing.T) {
	w, stop := buildPayWithItemWorld(t, "h1", "sc1", []pwiActor{
		{id: "hannah", displayName: "Hannah Boggs", kind: sim.KindNPCShared, huddleID: "h1"},
