...
func checkAndRotate(ctx context.Context, w *World, r *rand.Rand, scope RotationScope) {
	...
	// Bound to the daily boundary crossing HERE beside the farm-upkeep levy and for
	// the same reasons — the umbilical force-rotate must never pay it, and keying to the
