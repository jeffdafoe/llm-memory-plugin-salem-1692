...
const solicitWorkDescription = "Offer to do a job for another villager in your current conversation, for pay. " +
	...
	"You set who you'll work for (employer), the pay you want — coins (reward), goods they hold (reward_items, e.g. a meal), or both — and how long it takes (duration_minutes — a real stretch of work: 4, 6, or 8 hours). " +
...
const offerWorkDescription = "Ask another villager in your current conversation to do a job for you, for pay. " +
	...
	"You set who works (worker — they must take work for pay; your perception names who does), the pay you will hand over when the work is finished — coins (reward), goods you hold (reward_items, e.g. a meal), or both — and how long it takes (duration_minutes — a real stretch of work: 4, 6, or 8 hours). " +
	"Ask them aloud in the same breath by passing `say` — do NOT ask with the speak tool and then call this, because speaking ends your turn and the offer would never be made. " +
